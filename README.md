...
📌 Проекты на GitHub
- [API автотесты на Python + pytest](https://github.com/NataliaPankova-QA/api-autotests-python)
...
- [API автотесты на Python + pytest](https://github.com/NataliaPankova-QA/api-autotests-python) — пример тестирования REST API
